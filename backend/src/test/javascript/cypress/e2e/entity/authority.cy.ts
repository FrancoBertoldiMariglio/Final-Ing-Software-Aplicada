...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '345cdec9-6349-4763-96f5-b8fe607923af' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('8410b19b-09bf-4b63-8a69-f45e8f67f30c');
      cy.get(`[data-cy="name"]`).should('have.value', '8410b19b-09bf-4b63-8a69-f45e8f67f30c');
